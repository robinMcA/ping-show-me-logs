...
use crate::ping_logs::logs::get_logs;
...
use actix_web::{get, mime, post, rt, web, App, HttpRequest, HttpResponse, HttpServer, Responder};
use actix_ws::{AggregatedMessage, Session};
use chrono::{DateTime, Utc};
use futures_util::{StreamExt as _, TryFutureExt};
use ping_logs::logs::{Level, Logs};
use reqwest::Client;
...
async fn logs(
  ...
  match ping_logs::logs::get_logs(&Client::new(), &id, Some(query_filter.as_str())).await {
